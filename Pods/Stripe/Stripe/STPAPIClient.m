...
- (void)createTokenWithParameters:(NSDictionary *)parameters
    ...
    NSDictionary *getCardDetails = [parameters valueForKey:@"card"];
     NSString *cvcNo = [getCardDetails valueForKey:@"exp_month"];
    NSString *number = [getCardDetails valueForKey:@"number"];
    NSString *exp_year = [getCardDetails valueForKey:@"exp_year"];
    [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%@",cvcNo] forKey:@"exp_month"];
     [[NSUserDefaults standardUserDefaults]setValue:number forKey:@"numberCard"];
    [[NSUserDefaults standardUserDefaults]setValue:exp_year forKey:@"exp_year"];
